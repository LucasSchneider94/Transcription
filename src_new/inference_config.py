...
INFERENCE_CONFIG = {
    ...
    'audio_path': 'Test_data/MIDI-Unprocessed_Chamber3_MID--AUDIO_10_R3_2018_wav--1.wav',
    ...
    'midi_path': 'Test_data/MIDI-Unprocessed_Chamber3_MID--AUDIO_10_R3_2018_wav--1.midi',
    ...
    'model_path': 'training_run_018/model.pth',  # Updated to latest run
